				...
				if (rs.code === 200) {
					rs.uploadedImages.forEach(function (imgesLink) {
						if (imgesLink.Url.indexOf(".pdf") > 0) {
							imgTag += '<a href="' + imgesLink.Url + '"><img src="https://cdn.anpero.com/images/38/112020/stilrent-icon-set-pd2020110501074279.jpg" /></a>';
						} else if (imgesLink.Url.indexOf(".xls") > 0) {							
							imgTag += '<a href="' + imgesLink.Url + '"><img src="https://cdn.anpero.com/images/38/112020/xlsx2020110501045090.png" /></a>';
						} else if (imgesLink.Url.indexOf(".doc") > 0 || imgesLink.Url.indexOf(".pdf") > 0) {
							imgTag += '<a href="' + imgesLink.Url + '"><img src="https://cdn.anpero.com/images/38/112020/doc2020110500564978.png" /></a>';
						} else {
