        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'Phần mềm web quản lý bán hàng và tin tức mạnh mẽ tức thời',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    // (string | mandatory) the text inside the notification
                    text: 'Chúc bạn ngày làm việc vui vẻ!',
                    // (string | optional) the image to display on the left
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Lưu ý bảo mật với các link lạ!',
                    // (string | mandatory) the text inside the notification
                    text: 'luôn có khả năng bị mất mật khẩu, bị hack hệ thống nếu vào nhầm web có mã độc khách hàng gửi đến',
                    // (string | optional) the image to display on the left
                    image1: '/images/logo2.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
