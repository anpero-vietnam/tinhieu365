    ...
    public class News
    {
        ...
        public String getLinkBynews(int id,int st)
        {
            ...
            try
            {
                ...
                {
                    return domainNames + @"/" + Ultil.StringHelper.ConVertToMoneyString(tin.SubCategoryName) + "/" +
                           Ultil.StringHelper.ToURLgach(tin.Tittle) + @"-" + tin.Id;
                }
            }
            catch (Exception)
            {
            ...
            String publish, String prioty, String lang, String tag, String linkTag, int userID, int viewTime,int st)
        {
            ...
            NewsDesc = Ultil.StringHelper.RemoveScript(newcontent);
            ...
            try
            {
                ...
                paramList[1].Value = StringHelper.RemoveHexadecimalSymbols(tittle);

                paramList[2] = new SqlParameter("@content", SqlDbType.NText);
                paramList[2].Value = StringHelper.RemoveHexadecimalSymbols(newdesc1);
                ...
                paramList[11].Value = StringHelper.RemoveHexadecimalSymbols(_shortDesc);
        ...
        //        paramList[10].Value = StringHelper.RemoveHexadecimalSymbols(shortDesc);

        //        paramList[11] = new SqlParameter("@tag", SqlDbType.NVarChar, 50);
        //        paramList[11].Value = StringHelper.RemoveHexadecimalSymbols(tag);
            ...
            String uid)
        {
            try
            {
                ...
                Url = Ultil.StringHelper.RemoveHtmlTangs(Url);
                ...
                title = Ultil.StringHelper.RemoveHtmlTangs(title);
                paramList[3] = new SqlParameter("@title", SqlDbType.NVarChar, 1500);
                paramList[3].Value = title;
                
                TypeOfLink =Ultil.StringHelper.ToEndcodedingLeveForum(TypeOfLink);
