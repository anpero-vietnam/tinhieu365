namespace VNPAYMENT_NET_CS.Common
{
    ...
    public class ResponseObject
    {
        ...
        public bool IsValidSignature(string secretKey)
        {
            ...
            return Utils.Md5(this.Action + "|" + this.RspCode + "|" + this.TerminalId + "|" + this.OrderId + "|" + secretKey).Equals(this.Signature);
        }
        ...
        public string MakeSignature(string secretKey)
        {
            ...
            return Utils.Md5(this.Action + "|" + this.RspCode + "|" + this.TerminalId + "|" + this.OrderId + "|" + secretKey);
        }
